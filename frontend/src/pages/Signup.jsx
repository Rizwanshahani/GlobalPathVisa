  ...
  return (
    ...
    <Card className="w-full max-w-sm border border-slate-100 shadow-xl rounded-3xl overflow-hidden bg-white">
      <CardHeader>
        ...
        <CardDescription>
          Enter your giving details to create your account
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex-col gap-2">
        ...
        <p>Already have an account? <Link to={'/login'} className='hover:underline cursor-pointer text-pink-800'>Login</Link></p>
      </CardFooter>
    </Card>
    </div>
  )
